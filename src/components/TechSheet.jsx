import { likeIcon,dislikeIcon,tagIcon,bellIcon,playIcon } from "../assets/icons"

const TechSheet = () => {
    const dataExample = {
        imgCover:'https://elcomercio.pe/resizer/b0JhIoRba8vhwoCG4c3tkfdvHuw=/400x0/smart/filters:format(jpeg):quality(75)/cloudfront-us-east-1.images.arcpublishing.com/elcomercio/YH52SIXPWZFNJH2UFT2TNT66HM.jpg',
        sinopsis: "Loki es llevado ante la misteriosa organización llamada AVT (Autoridad de Variación Temporal) después de los acontecimientos ocurridos en 'Avengers: Endgame (2019)' y se le da a elegir enfrentarse a ser borrado de la existencia debido a que es una 'variante de tiempo' o ayudar a arreglar la línea de tiempo y detener una amenaza mayor.",
        cast: [
            {
                name: "Tom Hiddleston",
    ...
    return (
        <section className="px-6 my-8 flex flex-col items-center">
            <figure className="px-2">
                <img src={dataExample.imgCover} alt="foto de pelicula" />
            </figure>
            <a href="#" className="w-fit h-fit flex gap-4 items-center justify-center my-3 px-8 py-3 rounded-md bg-[#ABA8AB] text-black border-[1px] border-[#4C4545]">
                <img src={playIcon} className="w-6" alt="" />
                <p className="font-semibold uppercase">Ver trailer</p>
            </a>
            <section className="bg-white rounded-[0.32rem] p-4">
                <div className="flex items-start justify-between">
                    ...
                    <a href="#">
                        <figure>
                            <img src="https://sm.ign.com/ign_latam/cover/d/disney-plu/disney-plus_sxyh.jpg" className="w-16 rounded-lg" alt="" />
                        </figure>
                    </a>
                </div>
                <div>
